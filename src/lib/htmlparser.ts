...
export default class HtmlParser {
    ...
    while ((i2 = s.indexOf('<', i1)) >= 0) {
      ...
      if ((i2 = this.skipName(s, i1)) > i1) {
        ...
        if (!stripTriComments || s.charCodeAt(i1 + 3) != '-'.charCodeAt(0)) {
          ...
          new HtmlComment(p.ownerDocument as HtmlDocument, p, s.substring(i1 + 3, i2 - 3),
                  i1 + 3, i2 - 3, origin);
        }
        i3 = i1 = i2;
      }
  ...
  private parseElement(
    ...
    if (!selfclose && !VOID_ELEMENTS.has(e.tagName)) {
      if (SKIP_CONTENT_TAGS.has(e.tagName)) {
        ...
        if (res.i0 > i1) {
          new HtmlText(e.ownerDocument as HtmlDocument, e, s.substring(i1, res.i0),
  ...
  private parseAttributes(e: HtmlElement, s: string, i2: number, origin: number) {
  ...
  private skipComment(s: string, i1: number, origin: number) {
    if (s.charCodeAt(i1) === '!'.charCodeAt(0)
  ...
  private skipContent(tag: string, s: string, i1: number, origin: number) {
    var i2;
    while ((i2 = s.indexOf('</', i1)) >= 0) {
      var i0 = i2;
      i1 = i2 + 2;
  ...
  private skipBlanks(s: string, i: number) {
    while (i < s.length) {
  ...
  private skipName(s: string, i: number, acceptsDots = false) {
    while (i < s.length) {
